...
@JsonDeserialize(builder = RevokeTokensRequest.Builder.class)
public final class RevokeTokensRequest {
    /**
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof RevokeTokensRequest && equalTo((RevokeTokensRequest) other);
    }

    private boolean equalTo(RevokeTokensRequest other) {
        return
    ...
    public static final class Builder {
        ...
        public Builder from(RevokeTokensRequest other) {
        ...
        public RevokeTokensRequest build() {
            if (token == null) {
                throw new IllegalStateException("token is required");
            }

            return new RevokeTokensRequest(
                       clientId,
                       clientSecret,
                       token
                   );
