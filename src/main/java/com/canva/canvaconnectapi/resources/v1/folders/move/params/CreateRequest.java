package com.canva.canvaconnectapi.resources.v1.folders.move.params;
...
public final class CreateRequest {
    private final MoveFolderItemRequest data;

    private CreateRequest(
        MoveFolderItemRequest data
    ) {
        this.data = data;
    }
    ...
    @JsonProperty("data")
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public MoveFolderItemRequest getData() {
        return data;
    }
    ...
    public static final class Builder {
        private MoveFolderItemRequest data = null;
        ...
        @JsonSetter("data")
        public Builder data(MoveFolderItemRequest data) {
            if (data == null) {
