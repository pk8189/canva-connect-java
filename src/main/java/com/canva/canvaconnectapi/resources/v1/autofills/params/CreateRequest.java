package com.canva.canvaconnectapi.resources.v1.autofills.params;
...
public final class CreateRequest {
    private final CreateDesignAutofillJobRequest data;

    private CreateRequest(
        CreateDesignAutofillJobRequest data
    ) {
        this.data = data;
    }
    ...
    @JsonProperty("data")
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public CreateDesignAutofillJobRequest getData() {
        return data;
    }
    ...
    public static final class Builder {
        private CreateDesignAutofillJobRequest data = null;
        ...
        @JsonSetter("data")
        public Builder data(CreateDesignAutofillJobRequest data) {
            if (data == null) {
