package com.canva.canvaconnectapi.resources.v1.oauth.revoke.params;
...
public final class CreateRequest {
    private final RevokeTokensRequest data;

    private CreateRequest(
        RevokeTokensRequest data
    ) {
        this.data = data;
    }
    ...
    @JsonProperty("data")
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public RevokeTokensRequest getData() {
        return data;
    }
    ...
    public static final class Builder {
        private RevokeTokensRequest data = null;
        ...
        @JsonSetter("data")
        public Builder data(RevokeTokensRequest data) {
            if (data == null) {
