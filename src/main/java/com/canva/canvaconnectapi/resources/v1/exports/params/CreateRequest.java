...
public final class CreateRequest {
    private final CreateDesignExportJobRequest data;

    private CreateRequest(
        CreateDesignExportJobRequest data
    ) {
        this.data = data;
    }
    ...
    @JsonProperty("data")
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public CreateDesignExportJobRequest getData() {
        return data;
    }
    ...
    public static final class Builder {
        private CreateDesignExportJobRequest data = null;
        ...
        @JsonSetter("data")
        public Builder data(CreateDesignExportJobRequest data) {
            if (data == null) {
