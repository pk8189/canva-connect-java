package com.canva.canvaconnectapi.resources.v1.comments.params;
...
public final class CreateRequest {
    private final CreateCommentRequest data;
    ...
    @JsonProperty("data")
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public CreateCommentRequest getData() {
        return data;
    }
    ...
    public static final class Builder {
        private CreateCommentRequest data = null;
        ...
        @JsonSetter("data")
        public Builder data(CreateCommentRequest data) {
            if (data == null) {
