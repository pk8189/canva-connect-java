...
public final class CreateRequest {
    private final CreateDesignRequest data;
    ...
    @JsonProperty("data")
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public CreateDesignRequest getData() {
        return data;
    }
    ...
    public static final class Builder {
        private CreateDesignRequest data = null;
        ...
        @JsonSetter("data")
        public Builder data(CreateDesignRequest data) {
            if (data == null) {
